    ...
    private Vector<TaskHistoryTO> getListByTask(String taskId, Connection c) throws DataAccessException {
		...
		try {
			pstmt = c.prepareStatement("select th.task_id, th.resource_id, th.project_id, th.task_status_id, ts.state_machine_order, " +
									      ...
									      "t.requeriment_id, th.iteration, o.name as ITERATION_NAME " +
			...
			while (rs.next()){
			    ...
			    tto.setRequirement(new RequirementTO(getString(rs, "requeriment_id")));
