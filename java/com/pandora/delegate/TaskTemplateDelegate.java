...
public class TaskTemplateDelegate extends GeneralDelegate {
	...
	public void saveCustomNodeTemplate(Vector<CustomNodeTemplateTO> cnlist, Vector<TaskTO> tlist, UserTO handler) throws BusinessException{
		tnbus.saveCustomNodeTemplate(cnlist, tlist, handler);
	}
