...
public class ProjectRiskInPeriodGadget extends ChartGadget {
	...
	public String generate(Vector selectedFields)  throws BusinessException {
        ...
        try {
        	...
        	if (indicator.equals("1")) { //probability
        		...
        		barColors = new String[]{"00FF00", "FFFF00", "FF0000"};
        	}
            ...
            if (pto!=null) {
                ...
                response = "{ \n" + 
                	getJSonTitle() + "," +
                	getJSonYLegend("(" + super.getI18nMsg("label.qty") + ")") + "," + 
                	getBarStackValues(riskVals, labels, barColors, null, null, null, true) + "," +
                	getJSonAxis(xaxis, null, "x_axis") + "," + getJSonAxis(null, riskVals, "y_axis") + "}";
            } else {
