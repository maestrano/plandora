...
public class TaskNodeTemplateBUS extends GeneralBusiness {
	...
	public void saveCustomNodeTemplate(Vector<CustomNodeTemplateTO> cnlist, Vector<TaskTO> tlist, UserTO uto) throws BusinessException {
        try {
            dao.saveCustomNodeTemplate(cnlist, tlist, uto);
        } catch (DataAccessException e) {
            throw new  BusinessException(e);
        }
	}	
