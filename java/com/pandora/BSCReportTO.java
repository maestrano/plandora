...
public class BSCReportTO extends TransferObject implements Comparable<BSCReportTO> {
	...
	public int compareTo(BSCReportTO o) {
		Collator cot = Collator.getInstance();  
		String token1 = getProjectName() + "_" + getStrategyName(); 
		String token2 = o.getProjectName() + "_" + o.getStrategyName();
