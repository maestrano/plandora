...
<html:form action="applyTaskTemplate">
				    ...
				    <tr class="pagingFormBody">
				      ...
				      <td width="170" class="formBody">
					  		<html:select name="applyTaskTemplateForm" property="projectId" styleClass="textBox" onkeypress="javascript:changeProject();" onchange="javascript:changeProject();">
					             <html:options collection="projectList" property="id" labelProperty="name" filter="false" filter="false"/>
							</html:select>
				      </td>
				      ...
				      <td class="formBody">
					  		<html:select name="applyTaskTemplateForm" property="categoryId" styleClass="textBox">
					             <html:options collection="categoryList" property="id" labelProperty="name" filter="false" filter="false"/>
							</html:select>
				      </td>
				      <td width="10">&nbsp;</td>
				    </tr>		
				    <tr class="pagingFormBody">
				      ...
				      <td class="formBody" colspan="3">
					  		<html:select name="applyTaskTemplateForm" property="iterationId" styleClass="textBox">
					             <html:options collection="iterationList" property="id" labelProperty="name" filter="false" filter="false"/>
							</html:select>
				      </td>
				      <td width="10">&nbsp;</td>
				    </tr>		
	...
	<tr height="170" valign="bottom">
		...
		<td>
			...
			<tr class="formBody">
				<td>			
					<display:table border="1" width="100%" name="nodeTemplateList" scope="session" pagesize="5">
						...
						<display:column property="description" maxWords="10" align="left" title="label.formApplyTaskTemplate.desc" />
