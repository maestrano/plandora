				...
				<td>
					<logic:equal name="repositoryViewerForm" property="emulateCustomerViewer" value="off">
						<display:table border="1" width="100%" name="repositoryFileList" scope="session" pagesize="0" requestURI="../do/showRepositoryViewer?operation=refresh">
						  ...
						  <display:column width="20" property="id" align="center" title="grid.title.empty" description="label.formRepository.download.desc" decorator="com.pandora.gui.taglib.decorator.RepositoryDownloadDecorator" visibleProperty="<%=PreferenceTO.REPOSITORY_GRID_DOWNLOAD%>" />					  
						  ...
						  <display:column width="20" property="id" align="center" title="grid.title.empty" description="label.formRepository.del.desc" visibleProperty="<%=PreferenceTO.REPOSITORY_GRID_DEL%>" decorator="com.pandora.gui.taglib.decorator.RepositoryDeleteItemDecorator" />						  
						</display:table>
					</logic:equal>
