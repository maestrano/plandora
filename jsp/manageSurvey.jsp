...
<html:form action="manageSurvey">
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
		<tr class="formBody">
			<td>
				<plandora-html:ptable width="100%" name="surveyList" scope="session" pagesize="6" frm="surveyForm" >
					  <plandora-html:pcolumn width="2%" align="center" property="id" title="grid.title.empty" />
					  <plandora-html:pcolumn property="name" title="label.formSurvey.name" />
					  <plandora-html:pcolumn width="15%" align="center" property="publishingDate" title="label.formSurvey.publishing" decorator="com.pandora.gui.taglib.decorator.GridDateDecorator" tag="2;0" />
					  <plandora-html:pcolumn width="15%" align="center" property="finalDate" title="label.formSurvey.finaldate" decorator="com.pandora.gui.taglib.decorator.GridDateDecorator" tag="2;0" />
