...
<script language="JavaScript">
	...
	function showGantt(id, type){
		window.location = "../do/ganttPanel?operation=prepareForm&projectId=" + id + "&ts=" + getTs2Str();	
	}
		...
		<td>
			...
			<tr class="formBody">
				...
				<plandora-html:ptable width="100%" name="taskList" scope="session" pagesize="<%=PreferenceTO.HOME_TASKLIST_NUMLINE%>" frm="resourceHomeForm">
					  ...
					  <plandora-html:pcolumn sort="true" width="16%" align="center" comboFilter="true" property="task.project.name" title="label.manageTask.project" description="label.manageTask.project" visibleProperty="<%=PreferenceTO.HOME_TASKLIST_SW_PROJECT%>" />
				...
				<tr class="formBody">
					<td>
						<plandora-html:ptable width="100%" name="pendingCostList" scope="session" pagesize="<%=PreferenceTO.HOME_PENDLIST_NUMLINE%>" frm="resourceHomeForm">
						  ...
						  <plandora-html:pcolumn sort="true" width="120" comboFilter="true" align="center" property="project.name" title="label.grid.requestform.prj" description="label.grid.requestform.prj" visibleProperty="<%=PreferenceTO.HOME_PENDCOST_SW_PROJ%>"/>
			...
			<logic:equal name="resourceHomeForm" property="showPendingReq" value="on">
				...
				<tr class="formBody">
					...
					<plandora-html:ptable width="100%" name="pendRequirementList" scope="session" pagesize="<%=PreferenceTO.HOME_PENDLIST_NUMLINE%>" frm="resourceHomeForm">
					  ...
					  <plandora-html:pcolumn sort="true" width="13%" align="center" comboFilter="true" property="project.name" title="label.requestProject" description="label.requestProject" visibleProperty="<%=PreferenceTO.HOME_PENDLIST_SW_PROJ%>"/>
			...
			<tr class="formBody">
				...
				<plandora-html:ptable width="100%" name="myRequirementList" scope="session" pagesize="<%=PreferenceTO.HOME_REQULIST_NUMLINE%>" frm="resourceHomeForm">
					  ...
					  <plandora-html:pcolumn sort="true" width="12%" comboFilter="true" align="center" property="project.name" title="label.requestProject" description="label.requestProject" visibleProperty="<%=PreferenceTO.HOME_REQLIST_SW_PROJ%>" />
