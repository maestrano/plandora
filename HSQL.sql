...
drop table requeriment_history;
drop table resource_task;
drop table task;
drop table requeriment;
drop table task_status;
drop table requeriment_status;
drop table root;
drop table leader;
drop table resource;
drop table customer;
...
primary key (requeriment_id, requeriment_status_id, creation_date)
);
...
alter table customer_function add constraint cus_func_customer foreign key (customer_id, project_id) references customer (id, project_id);
