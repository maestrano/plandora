	...
	<tr class="formBody">
		<td>
		    <plandora-html:ptable width="100%" name="allResTaskList" scope="session" pagesize="<%=PreferenceTO.LIST_ALL_SHOW_PAGING%>" frm="showAllTaskForm" >
				  ...
				  <plandora-html:pcolumn sort="true" width="6%" comboFilter="true" property="id" align="center" title="label.resTaskForm.billable" description="label.showAllTaskForm.billable.desc" visibleProperty="<%=PreferenceTO.LIST_ALL_TSK_BILLABLE%>" decorator="com.pandora.gui.taglib.decorator.TaskBillableDecorator" tag="EDIT"/>
				  ...
				  <plandora-html:pcolumn sort="true" width="5%" align="center" property="id" title="label.gridParent" description="label.gridParent.desc" visibleProperty="<%=PreferenceTO.HOME_TASKLIST_SW_TSK_PARENT%>" decorator="com.pandora.gui.taglib.decorator.GridMindMapLinkDecorator" tag="PARENT_ID"/>
				  ...
				  <plandora-html:pcolumn sort="true" width="10%" comboFilter="true" align="center" property="id" title="label.manageTask.category" description="label.showAllTaskForm.category.desc" visibleProperty="<%=PreferenceTO.HOME_TASKLIST_SW_TSK_CATEG%>" decorator="com.pandora.gui.taglib.decorator.TaskCategoryDecorator" />
